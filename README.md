...
- 责任描述：基于 taro 框架，负责项目的需求分析、功能设计、代码实现和测试。保证迭代的代码质量。 

### 微购相册  

- 项目描述：微购相册有一个基于 taro 框架的微信小程序项目；还有一款是基于 React 框架的 h5 项目。主要功能包括商品上传、商品分享、购物车和会员中心等模块。
- 责任描述：主要负责微购相册的会员中心模块。完成从 会员中心1.0 到 会员中心5.0 的迭代。
...
- 项目描述：一款基于微信小程序原生框架的工品商城项目，主要功能包括商品详情、购物车、会员中心、订单管理、支付功能、分享功能、收藏功能、搜索功能、评价功能、用户信息管理功能、用户地址管理功能、用户收藏管理功能、用户支付和订单管理功能、用户注册和登录管理功能。
- 责任描述：负责项目的需求分析、功能设计、代码实现和测试。保证商城小程序正常上线。
...
此外还熟悉原生微信小程序开发、基于 Taro 的小程序开发和基于 React 的移动端应用开发
